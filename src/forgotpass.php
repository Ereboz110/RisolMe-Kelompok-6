                ...
                <div class="w-full max-w-md">
                    ...
                    <form>
                        ...
                        <div class="flex space-x-4">
                            <button type="button" class="w-1/2 bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-300" onclick="window.location.href='landing.php'">Cancel</button>
                            <button type="submit" class="w-1/2 bg-gray-800 text-white py-2 px-4 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500" onclick="window.location.href='#'">Reset Password</button>
                        </div>
                    </form>
                </div>
            </div>
